...
4. Assume a standard C++17 environment (e.g. GCC/Clang on Linux). Do NOT mix C++20-only features.
5. UNDEFINED BEHAVIOR: Do not create questions where the correct answer depends on undefined behavior (e.g., dangling pointers, invalid iterator usage) UNLESS the question is a Debugging or Conceptual question specifically asking to identify the undefined behavior.
...
8. Provide a clear, educational explanation for the correct answer. Focus on placement preparation.
