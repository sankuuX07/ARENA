...
export const PythonSessionPage: React.FC = () => {
  ...
  if (loading) return <div style={{ padding: '4rem', textAlign: 'center' }}>Generating Python Programming Questions...<br/><small style={{color:'var(--text-secondary)'}}>(This may take a moment for larger sets)</small></div>;
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <h2 style={{ margin: 0, fontSize: '1.2rem', color: 'var(--text-secondary)' }}>
          Practice: <span style={{ color: 'var(--text-main)', textTransform: 'capitalize' }}>Python / {session.topic.replace('_', ' ')}</span>
        </h2>
